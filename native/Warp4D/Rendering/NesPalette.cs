...
{
    // FCEUX/Mesen-like NTSC palette. Palette RAM values select one of these 64 RGB colors.
    ...
    public static Color Get(byte paletteIndex)
    {
        int rgb = Rgb[paletteIndex & 0x3F];
